...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Pixel Perfect Vision is a web application for creating custom wedding invitation visuals." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Pixel Perfect Vision is a web application for creating custom wedding invitation visuals." },
